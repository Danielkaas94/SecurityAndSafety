...
#Import RandomForrest Classifier model
from sklearn.ensemble import RandomForestClassifier

#Create RandomForrest Classifier
...
# Model Accuracy, how often is the classifier correct?
print("RandomForrest Accuracy:",metrics.accuracy_score(y_test, y_pred))
...
#Create RandomForrest Classifier
rf = RandomForestClassifier(n_jobs=-1, random_state=3, n_estimators=102)
