...
# X = penguins.drop(columns=['species'])
# X = penguins.drop(columns=['species'], axis=1)
# X = penguins.drop(columns=['species'])
X = penguins.drop(columns=['species','island','sex'])
y = penguins['species']
...
# dbscan = DBSCAN(eps=0.5, min_samples=3)  # ganske få - 3 grønne
# dbscan = DBSCAN(eps=0.5, min_samples=4)   # Ganske få har den grønne/lilla kategori
# dbscan = DBSCAN(eps=0.58, min_samples=3)     # Her mister vi et kategori
# dbscan = DBSCAN(eps=0.564, min_samples=1)     # 22+ kategorier 🥇
dbscan = DBSCAN(eps=0.564, min_samples=7)     # 4 kategorier, med lidt noise 🥇
# dbscan = DBSCAN(eps=0.664, min_samples=16)     # 4 kategorier, med lidt noise 
# dbscan = DBSCAN(eps=0.684, min_samples=16)     # !4 kategorier, med lidt noise 
# dbscan = DBSCAN(eps=0.7, min_samples=16)     # !4 kategorier, med lidt noise 
# dbscan = DBSCAN(eps=0.664, min_samples=16)     # 4 kategorier, med lidt noise 
# dbscan = DBSCAN(eps=0.683859, min_samples=16)     # 4 kategorier, med lidt noise 
dbscan = DBSCAN(eps=0.683869, min_samples=16)     # 4 kategorier, med lidt noise 🥇

# dbscan = DBSCAN(eps=0.56, min_samples=3)     # 3 kategorier, med lidt noise 🥇
# dbscan = DBSCAN(eps=0.65, min_samples=10)     # 3 kategorier, med lidt noise
# dbscan = DBSCAN(eps=0.667, min_samples=10)     # 3 kategorier, med lidt noise
# dbscan = DBSCAN(eps=0.6671135, min_samples=10)     # 3 kategorier, med lidt noise 🥇
