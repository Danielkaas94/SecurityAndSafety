...
# kmeans = KMeans(n_clusters=6) # 3 fine clusters!
...
# X = penguins[['bill_length_mm', 'bill_depth_mm', 'flipper_length_mm', 'body_mass_g']] # Faktisk pænere clusters uden frasortering af features
...
# Print statistics
# print(Fore.YELLOW, kmeans.random_state) # Kæft det er dumt, at man ikke kan få random, hvis man ikke har skrevet random??!?!?!?
...
dbscan = DBSCAN(eps=0.5, min_samples=5)   # Initial version 1️⃣ - V-measure: 0.66 - 4 clusters
# dbscan = DBSCAN(eps=0.585, min_samples=7) # Best version 🥇 - V-measure: 0.75  - 3 clusters



# dbscan = DBSCAN(eps=0.683869, min_samples=16) # Best version with 4 clusters 🥇 - V-measure: 0.69
"""
Homogeneity: 0.79
Completeness: 0.61
V-measure: 0.69
...
Sizes of clusters: [127, 28, 14, 113]
"""
...
homogeneity, completeness, v_measure = homogeneity_completeness_v_measure(penguins['species'], dbscan.labels_)
...
"""penguins['species'] 4 Clusters

12 - eps=0.4, min_samples=5
Homogeneity: 0.49
Completeness: 0.28
V-measure: 0.36
Number of clusters: 12
Number of noise points: 169
Sizes of clusters: [9, 23, 12, 9, 5, 5, 12, 8, 4, 19, 39, 19]

5 - eps=0.45, min_samples=5
Homogeneity: 0.65
Completeness: 0.48
V-measure: 0.55
Number of clusters: 5
Number of noise points: 109
Sizes of clusters: [98, 13, 22, 87, 4]
...
3 - eps=0.55, min_samples=5
Homogeneity: 0.82
Completeness: 0.67
V-measure: 0.74
Number of clusters: 3
Number of noise points: 44
Sizes of clusters: [128, 50, 111]

3 - eps=0.57, min_samples=5
Homogeneity: 0.82
Completeness: 0.68
V-measure: 0.74
Number of clusters: 3
Number of noise points: 39
Sizes of clusters: [132, 51, 111]

eps=0.585, min_samples=5
Homogeneity: 0.83
Completeness: 0.69
V-measure: 0.75
Number of clusters: 3
Number of noise points: 35
Sizes of clusters: [134, 52, 112]

2 - eps=0.6, min_samples=5
Homogeneity: 0.57
Completeness: 0.66
V-measure: 0.61
Number of clusters: 2
Number of noise points: 32
Sizes of clusters: [189, 112]




9 - eps=0.5, min_samples=2
Homogeneity: 0.84
Completeness: 0.61
V-measure: 0.70
Number of clusters: 9
Number of noise points: 39
Sizes of clusters: [122, 4, 2, 2, 2, 47, 2, 111, 2]

4 - eps=0.5, min_samples=3 (grøn Cluster er meget lille)
Homogeneity: 0.82
Completeness: 0.64
V-measure: 0.72
Number of clusters: 4
Number of noise points: 49
Sizes of clusters: [122, 4, 47, 111]

5 - eps=0.5, min_samples=4
Homogeneity: 0.80
Completeness: 0.60
V-measure: 0.69
Number of clusters: 5
Number of noise points: 57
Sizes of clusters: [116, 2, 4, 44, 110]

4 - eps=0.5, min_samples=6
Homogeneity: 0.75
Completeness: 0.56
V-measure: 0.64
Number of clusters: 4
Number of noise points: 74
Sizes of clusters: [110, 16, 27, 106]


# So eps=585, min samples=5 seems to be the best with 3 clusters
# Let's keep eps=585 and change samples a few times

Beat V-measure: 0.75
2 - eps=0.585, min_samples=4
Homogeneity: 0.57
Completeness: 0.67
V-measure: 0.62
Number of clusters: 2
Number of noise points: 31
Sizes of clusters: [190, 112]

3 - eps=0.585, min_samples=6
Homogeneity: 0.81
Completeness: 0.67
V-measure: 0.74
Number of clusters: 3
Number of noise points: 40
Sizes of clusters: [133, 49, 111]

3 - eps=0.585, min_samples=7
Homogeneity: 0.80
Completeness: 0.65
V-measure: 0.72
Number of clusters: 3
Number of noise points: 46
Sizes of clusters: [129, 47, 111]

# Does not seems to be better.
"""
...
# Feature Selection med AR (Attribute Ratio)

# Linear decision boundary 

print(penguins.describe())

penguins.hist(bins=50,figsize=(20,15))
plt.show()
